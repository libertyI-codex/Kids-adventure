(function (global) {
  ...
  function companionLayout(appData, focusSpeciesId) {
    ...
    var sets = {
      ...
      14: [{ x: 50, y: 43, scale: 0.6 }, { x: 7, y: 60, scale: 0.4 }, { x: 21, y: 62, scale: 0.4 }, { x: 35, y: 63, scale: 0.4 }, { x: 50, y: 63, scale: 0.4 }, { x: 65, y: 63, scale: 0.4 }, { x: 79, y: 62, scale: 0.4 }, { x: 93, y: 60, scale: 0.38 }, { x: 8, y: 82, scale: 0.36 }, { x: 25, y: 82, scale: 0.36 }, { x: 42, y: 82, scale: 0.36 }, { x: 58, y: 82, scale: 0.36 }, { x: 75, y: 82, scale: 0.36 }, { x: 92, y: 82, scale: 0.34 }],
      15: [{ x: 50, y: 42, scale: 0.58 }, { x: 7, y: 60, scale: 0.38 }, { x: 21, y: 62, scale: 0.38 }, { x: 35, y: 63, scale: 0.38 }, { x: 50, y: 63, scale: 0.38 }, { x: 65, y: 63, scale: 0.38 }, { x: 79, y: 62, scale: 0.38 }, { x: 93, y: 60, scale: 0.36 }, { x: 7, y: 82, scale: 0.34 }, { x: 21, y: 82, scale: 0.34 }, { x: 35, y: 82, scale: 0.34 }, { x: 50, y: 82, scale: 0.34 }, { x: 65, y: 82, scale: 0.34 }, { x: 79, y: 82, scale: 0.34 }, { x: 93, y: 82, scale: 0.32 }]
    };
    var positions = sets[Math.min(15, Math.max(1, owned.length))] || [];
