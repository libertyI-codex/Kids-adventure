(function (global, document) {
  ...
  var HOTFIX_QUERY = "v=10p16";
  var APP_VERSION = "1.0.0-prototype.16";
  var VERSION_LABEL = "Ver.1.0 試作16";
  ...
  function normalStartUrl() {
    ...
    for (var i = 0; i < pairs.length; i += 1) {
      ...
      if (key === "v") next.push("v=10p16");
      else next.push(pairs[i]);
    }
    if (next.join("&").indexOf("v=10p16") < 0) next.push("v=10p16");
