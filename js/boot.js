(function (global, document) {
  ...
  var HOTFIX_QUERY = "v=10p12h2";
  var APP_VERSION = "1.0.0-prototype.12-hotfix.2";
  var VERSION_LABEL = "Ver.1.0 試作12 修正版2";
  ...
  function safeStartUrl() {
    ...
    href = updateQuery(href, "v", "10p12h2");
    return href;
  }
  ...
  function normalStartUrl() {
    ...
    for (var i = 0; i < pairs.length; i += 1) {
      ...
      if (key === "v") next.push("v=10p12h2");
      else next.push(pairs[i]);
    }
    if (next.join("&").indexOf("v=10p12h2") < 0) next.push("v=10p12h2");
