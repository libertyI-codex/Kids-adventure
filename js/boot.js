(function (global, document) {
  ...
  var HOTFIX_QUERY = "v=10p29";
  var APP_VERSION = "1.0.0-prototype.29";
  var VERSION_LABEL = "Ver.1.0 試作29";
  ...
  function normalStartUrl() {
    ...
    for (var i = 0; i < pairs.length; i += 1) {
      ...
      if (key === "v") next.push("v=10p29");
      else next.push(pairs[i]);
    }
    if (next.join("&").indexOf("v=10p29") < 0) next.push("v=10p29");
