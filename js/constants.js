(function (global) {
  ...
  KA.constants = {
    ...
    PROJECT_NAME: "こどもの冒険",
    APP_VERSION: "1.0.0-prototype.30",
    VERSION_LABEL: "Ver.1.0 試作30",
    SCHEMA_VERSION: 1,
    ...
    COLORING_TEMPLATES: [
      ...
      },
      {
        ...
        designVersion: 10,
        svgKey: "dolphin_streamlined_v10",
        viewBox: "0 0 240 180",
        regionAliases: {
          body_top: ["body"],
          snout: ["nose", "body"],
      ...
      },
      {
        ...
        designVersion: 10,
        svgKey: "dinosaur_friendly_side_v10",
        viewBox: "0 0 240 180",
        regionAliases: {
          neck: ["body"],
          arm: ["legs"],
      ...
      },
      {
        ...
        designVersion: 10,
        svgKey: "horse_clear_profile_v10",
        viewBox: "0 0 240 180",
        regionAliases: {
          ears: ["head"],
          front_leg_near: ["legs"],
      ...
      },
      {
        ...
        designVersion: 3,
        svgKey: "lion_mane_profile_v3",
        viewBox: "0 0 240 180",
        regionAliases: {
          face: ["head"],
          ears: ["ear_left", "ear_right"],
          front_leg: ["front_legs", "legs"],
          back_leg: ["back_legs", "legs"],
          tail_tip: ["tail_tuft"],
          paw: ["paws", "feet"]
        },
      ...
      },
      {
        ...
        designVersion: 3,
        svgKey: "grasshopper_long_leg_v3",
        viewBox: "0 0 240 180",
        regionAliases: {
          thorax: ["body"],
          abdomen: ["body"],
