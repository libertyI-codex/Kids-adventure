...
Ver.1.0 試作15では、たまごから生まれる鳥の仲間6種類の原画を手修正しました。ひよこ、あひる、オウム、くじゃく、ふくろう、すずめの見た目だけを調整し、たまご育成、なかまずかん、親モードのぬりえ設定、起動診断、safeStartモードは維持しています。

## バージョン
- 表示名: 結羽ちゃんの冒険
- バージョン: Ver.1.0 試作15
- appVersion: `1.0.0-prototype.15`
- schemaVersion: `1`
- キャッシュ対策: `?v=10p15`

## 試作15の鳥原画修正
鳥の仲間6種類は、画像生成・外部画像・外部SVGを使わず、既存のインラインSVG定義を手修正しました。
...
- 画像パス: `./apple-touch-icon.png?v=10p15`
- 最低表示時間: 1.2秒
- 通常終了目安: 初期化完了後
- フェイルセーフ: 約4秒
- フェードアウト後にDOMから除去
