...
Ver.1.0 試作14では、たまごのお世話を「なでる」「あたためる」「うたをうたう」の3種類に増やし、おしごと・ぬりえを含めて1日最大5ポイント育つようにしました。初めて孵化させるたまごだけは4ポイントでreadyになり、2個目以降は6ポイントでreadyになります。試作13の親モード「ぬりえ設定」と、試作12修正版2の起動診断、復旧画面、safeStartモードは維持しています。

## バージョン
- 表示名: 結羽ちゃんの冒険
- バージョン: Ver.1.0 試作14
- appVersion: `1.0.0-prototype.14`
- schemaVersion: `1`
- キャッシュ対策: `?v=10p14`
...
- 画像パス: `./apple-touch-icon.png?v=10p14`
- 最低表示時間: 1.2秒
- 通常終了目安: 初期化完了後
- フェイルセーフ: 約4秒
- フェードアウト後にDOMから除去
