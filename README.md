...
Ver.1.0 試作8の子ども向け表示名は **結羽ちゃんの冒険** です。
...
| うさぎ | `coloring_rabbit_001` | 12 | 8 |
| ねこ | `coloring_cat_001` | 16 | 5 |
| イルカ | `coloring_dolphin_001` | 20 | 8 |
| きょうりゅう | `coloring_dinosaur_001` | 24 | 8 |
| うま | `coloring_horse_001` | 28 | 8 |
| ライオン | `coloring_lion` | 32 | 1 |
| パンダ | `coloring_panda` | 36 | 1 |
| バッタ | `coloring_grasshopper` | 40 | 1 |
