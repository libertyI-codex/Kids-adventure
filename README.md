...
Ver.1.0 試作23では、機能と保存データを変えずに、ホームを中心としたUI/UXを整理しました。「きょうの ぼうけん」で、おしごと、おせわ、ごはん、おでかけ、おみやげの状態を一目で確認でき、代表の鳥またはたまごと次に押すボタンをホーム上部へ表示します。
...
- 画像パス: `./apple-touch-icon.png?v=10p23`
- 最低表示時間: 1.2秒
- 通常終了目安: 初期化完了後
- フェイルセーフ: 約4秒
- フェードアウト後にDOMから除去
...
- manifest: `./manifest.webmanifest?v=10p23`
