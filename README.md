...
Ver.1.0 試作19では、卵から生まれた鳥たちが一緒に暮らす「とりのおうち」を追加しました。取得済みの鳥の表示、タップでの触れ合い、家具12種類、固定配置枠8か所、模様替え、家具図鑑、NEW通知を追加しつつ、iPhone standalone対応、たまご育成、とりさんキッチン、りょうりずかん、親モードのぬりえ設定、起動診断、safeStartモードは維持しています。
...
- 画像パス: `./apple-touch-icon.png?v=10p19`
- 最低表示時間: 1.2秒
- 通常終了目安: 初期化完了後
- フェイルセーフ: 約4秒
- フェードアウト後にDOMから除去
...
- manifest: `./manifest.webmanifest?v=10p19`
