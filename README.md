...
Ver.1.0 試作17では、くじゃくの尾羽は試作16の大きさを維持しつつ、小さすぎた顔・体を0.75倍へ戻して、尾羽と本体のバランスを調整しました。iPhone standalone対応、たまご育成、なかまずかん、親モードのぬりえ設定、起動診断、safeStartモードは維持しています。
...
- 画像パス: `./apple-touch-icon.png?v=10p17`
- 最低表示時間: 1.2秒
- 通常終了目安: 初期化完了後
- フェイルセーフ: 約4秒
- フェードアウト後にDOMから除去
...
- manifest: `./manifest.webmanifest?v=10p17`
